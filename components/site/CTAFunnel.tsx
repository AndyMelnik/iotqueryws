...
function BigCard({
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: selected || hovered ? "#b300ff" : "rgba(224,234,255,0.5)" }}>{icon}</span>
      </div>
      <div className="flex-1 min-w-0 text-left">
        <div
          className="text-sm font-bold leading-snug"
          style={{ color: selected || hovered ? "#e0eaff" : "rgba(224,234,255,0.75)" }}
        >
          {label}
        </div>
      </div>
...
export default function CTAFunnel() {
  ...
  const toggleOperationsArea = (label: string) => {
    setFunnel((f) => ({
      ...f,
      operationsArea: f.operationsArea.includes(label)
        ? f.operationsArea.filter((x) => x !== label)
        : [...f.operationsArea, label],
    }));
  };
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight" style={{ color: "#e0eaff" }}>
            Find your <span className="neon-text">analytics starting point</span>
          </h2>
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(rgba(179,0,255,0.06) 1px,transparent 1px),linear-gradient(90deg,rgba(179,0,255,0.06) 1px,transparent 1px)",
              ...
              {submitted ? (
                    ...
                    {[
                      ...
                      <div key={r.label} className="flex items-start gap-2">
                        ...
                        <span className="text-xs" style={{ color: "rgba(224,234,255,0.65)" }}>
                          <span style={{ color: "#e0eaff", fontWeight: 600 }}>{r.label}: </span>
                          {r.val}
                        </span>
                      </div>
                    ))}
                ...
                <motion.div key="step1" custom={dir} variants={slideVariants} initial="enter" animate="center" exit="exit">
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      disabled={funnel.outcomeGoal.length === 0}
                      onClick={() => go(2)}
                    >
                ...
                <motion.div key="step2" custom={dir} variants={slideVariants} initial="enter" animate="center" exit="exit">
                  ...
                  <div className="flex items-center justify-between">
                    <button
                      ...
                      style={{ color: "rgba(224,234,255,0.45)", cursor: "pointer" }}
                    >
                    ...
                    <button
                      type="button"
                      className="neon-btn flex items-center gap-2 text-sm"
                      disabled={funnel.customerType.length === 0}
                      onClick={() => go(3)}
                    >
                ...
                <motion.div key="step3" custom={dir} variants={slideVariants} initial="enter" animate="center" exit="exit">
                  ...
                  <div className="flex flex-col gap-2 mb-8">
                    {[
                      {
                        label: "Use embeded Dashboard Studio for custom dashboards and reports",
                        icon: <LayoutDashboard size={18} />,
                      },
                      ...
                      {
                        label: "Develop AI-based tools and assistants, MCP servers, n8n automation flows, etc.",
                        icon: <Bot size={18} />,
                      },
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      onClick={() => {
                        setForm((f) => ({ ...f, role: funnel.customerType.join(", ") }));
                        go(4);
                      }}
                    >
                ...
                <motion.div key="step4" custom={dir} variants={slideVariants} initial="enter" animate="center" exit="exit">
                  ...
                  >
                    {[...funnel.outcomeGoal, ...funnel.customerType, ...funnel.operationsArea]
                      .filter(Boolean)
                      .map((tag) => (
                        <span
                          key={tag}
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                      ...
                      {[
                        ...
                        <div key={field.id} className="flex flex-col gap-1.5">
                          <label
                            ...
                            style={{ color: "rgba(224,234,255,0.4)", fontFamily: "var(--font-jetbrains-mono)" }}
                          >
                            {field.label}
                          </label>
                          <input
                    ...
                    <div className="flex flex-col gap-2">
                      {[
                        ...
                        ...(isPartner ? [{ id: "wantsPartner", label: "I want a partner / reseller conversation" }] : []),
                      ].map((cb) => (
                        <label key={cb.id} className="flex items-center gap-3 cursor-pointer group">
                          ...
                          <span className="text-sm" style={{ color: "rgba(224,234,255,0.65)" }}>
                            {cb.label}
                          </span>
                        </label>
                      ))}
